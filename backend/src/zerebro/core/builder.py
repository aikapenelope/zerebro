...
The builder uses a high-reasoning model (OpenAI) with ``response_format``
...
require deep thinking. Uses OpenAI.
"""
...
def create_builder_graph() -> CompiledStateGraph:
    ...
    The builder uses the configured builder model (typically OpenAI) and
